...
Промпт бота:
```
Привет, я помогу тебе найти любую книгу. Для начала пользования напиши \start, — а также вернёт в главное меню.
Если ответ бота содержит строчку формата "1 — ..." — это означает, что это является командой.
```
...
Промпт бота:
```
Вы ещё не добавили ни одного произведения в избранное!
```
```
1 — ✅ 1984
